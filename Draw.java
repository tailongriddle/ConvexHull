 ...
 *  This is the object-oriented version of DU draw; it supports
...
public final class Draw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    class UpdateLoop implements ActionListener {
        @Override
    ...
    // Update time, time between frames in ms
    ...
    /**
     * Getter for the amount of time a frame 'pauses' for
     *
    ...
    /**
     * Change speed of update loop while update() is running
     *
     * @param updateTime the new frame speed
     */
    public void setFrameTime(int updateTime) {
        ...
        // Set new update speed
        this.updateTimer = new Timer(updateTime, new UpdateLoop());
    ...
    public void startUpdate(){
        ...
        if(this.updateTimer == null){
            this.updateTimer = new Timer(this.updateTime, new UpdateLoop());
        }
        this.updateTimer.stop();
        this.updateTimer.start();
        this.running = true;
    ...
    /**
     *
     * @return an array containing the min and max of the x scale
     */
    ...
    /**
     *
     * @return an array containing the min and max of the y scale
     */
     ...
     */
    public Color getPixelColor(double pixelX, double pixelY) {
    ...
    ***************************************************************************/
     ...
     *
     * @param red the red value for the color to clear
     * @param green the blue value for the color to clear
     * @param blue the green value for the color to clear
     * @throws IllegalArgumentException if {@code color} is {@code null}
     */
    ...
    /**
     * Sets the pen size to the default (0.5).
     */
    ...
    ***************************************************************************/
     ...
     * @throws IllegalArgumentException if any argument is either NaN or infinite
     */
    public void annulus(double x, double y, double radius1, double radius2) {
        validate(x, "x");
        validate(y, "y");
     ...
     * @throws IllegalArgumentException if any argument is either NaN or infinite
     */
    public void filledAnnulus(double x, double y, double radius1, double radius2) {
        validate(x, "x");
        validate(y, "y");
        validate(radius1, "radius1");
        validateNonnegative(radius1, "radius1");
     ...
     * @throws IllegalArgumentException if any coordinate is either NaN or infinite
     */
    public void triangle(double x0, double y0, double x1, double y1, double x2, double y2) {
    	validate(x0, "x0");
    	validate(x1, "x1");
    	validate(x2, "x2");
    	validate(y0, "y0");
     ...
     * @throws IllegalArgumentException if any coordinate is either NaN or infinite
     */
    public void filledTriangle(double x0, double y0, double x1, double y1, double x2, double y2) {
    	validate(x0, "x0");
    	validate(x1, "x1");
    	validate(x2, "x2");
    	validate(y0, "y0");
     ...
     * @throws IllegalArgumentException if any coordinate is either NaN or infinite
     */
    public void quadrilateral(double x0, double y0, double x1, double y1, double x2, double y2, double x3, double y3) {
    	validate(x0, "x0");
    	validate(x1, "x1");
    	validate(x2, "x2");
    	validate(x3, "x3");
     ...
     * @throws IllegalArgumentException if any coordinate is either NaN or infinite
     */
    public void filledQuadrilateral(double x0, double y0, double x1, double y1, double x2, double y2, double x3, double y3) {
    	validate(x0, "x0");
    	validate(x1, "x1");
    	validate(x2, "x2");
    	validate(x3, "x3");
     ...
     * @throws IllegalArgumentException if any argument is either NaN or infinite
     */
    public void sector(double x, double y, double radius, double angle1, double angle2) {
        validate(x, "x");
        validate(y, "y");
        validate(radius, "arc radius");
        validate(angle1, "angle1");
     ...
     * @throws IllegalArgumentException if any argument is either NaN or infinite
     */
    public void filledSector(double x, double y, double radius, double angle1, double angle2) {
        validate(x, "x");
        validate(y, "y");
        validate(radius, "arc radius");
        validate(angle1, "angle1");
     ...
     * @throws IllegalArgumentException if any argument is either NaN or infinite
     */
    public void ellipticalSector(double x, double y, double semiMajorAxis, double semiMinorAxis, double angle1, double angle2) {
        validate(x, "x");
        validate(y, "y");
        validate(semiMajorAxis, "semimajor axis");
        validate(semiMinorAxis, "semiminor axis");
     ...
     * @throws IllegalArgumentException if any argument is either NaN or infinite
     */
    public void filledEllipticalSector(double x, double y, double semiMajorAxis, double semiMinorAxis, double angle1, double angle2) {
        validate(x, "x");
        validate(y, "y");
        validate(semiMajorAxis, "semimajor axis");
        validate(semiMinorAxis, "semiminor axis");
     ...
     * @throws IllegalArgumentException if any argument is either NaN or infinite
     */
    public void ellipticalArc(double x, double y, double semiMajorAxis, double semiMinorAxis, double angle1, double angle2) {
        validate(x, "x");
        validate(y, "y");
        validate(semiMajorAxis, "semimajor axis");
        validate(semiMinorAxis, "semiminor axis");
    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) {
        ...
        draw1.setPenRadius(0.5);
        draw1.arc(0.8, 0.2, 0.1, 200, 45);
        draw1.setPenRadius(3);
        draw1.line(0.25, 0.5, 0.25, 0.5);
        draw1.line(0.5, 0.5, 0.5, 0.5);
        draw1.line(0.75, 0.5, 0.75, 0.5);
